...
def _1_get_url(page, pic_type):
    # 如果 search=today  那么则返回今日话题
    # if pic_type == '1':
    #     url = 'https://t66y.com/thread0806.php?fid=7&search=today&page=' + page  # 技术交流
    # if pic_type == '2':
    #     url = 'https://t66y.com/thread0806.php?fid=8&search=today&page=' + page  # 新時代的我們
    # if pic_type == '3':
    #     url = 'https://t66y.com/thread0806.php?fid=16&search=today&page=' + page  # 達蓋爾的旗幟
